...
Rectangle.prototype = {
    ...
    */
    ...
    /**
    * Adjusts the location of the Rectangle object using a Vec2 object as a parameter. This method is similar to the Rectangle.offset() method, except that it takes a Vec2 object as a parameter.
    * @method Rectangle#offsetPoint
    * @param {Vec2} point - A Vec2 object to use to offset this Rectangle object.
    * @return {Rectangle} This Rectangle object.
    */
    ...
    */
    ...
    /**
    * The size of the Rectangle object, expressed as a Vec2 object with the values of the width and height properties.
    * @method Rectangle#size
    * @param {Vec2} [output] - Optional Vec2 object. If given the values will be set into the object, otherwise a brand new Vec2 object will be created and returned.
    * @return {Vec2} The size of the Rectangle object.
    */
    ...
    */
    containsRect: function (b) {
        return Rectangle.containsRect(this, b);
    },
    ...
    */
    intersects: function (b, tolerance) {
        return Rectangle.intersects(this, b, tolerance);
    },
...
/**
* The location of the Rectangles bottom right corner as a Vec2 object.
* @name Rectangle#bottom
* @property {Vec2} bottomRight - Gets or sets the location of the Rectangles bottom right corner as a Vec2 object.
*/
...
/**
* The location of the Rectangles top left corner as a Vec2 object.
* @name Rectangle#topLeft
* @property {Vec2} topLeft - The location of the Rectangles top left corner as a Vec2 object.
*/
...
/**
* Increases the size of the Rectangle object. This method is similar to the Rectangle.inflate() method except it takes a Vec2 object as a parameter.
* @method Rectangle.inflatePoint
* @param {Rectangle} a - The Rectangle object.
* @param {Vec2} point - The x property of this Vec2 object is used to increase the horizontal dimension of the Rectangle object. The y property is used to increase the vertical dimension of the Rectangle object.
...
Rectangle.size = function (a, output) {
    if (typeof output === "undefined") { output = new Vec2(); }
...
/**
* Determines whether the specified point is contained within the rectangular region defined by this Rectangle object. This method is similar to the Rectangle.contains() method, except that it takes a Vec2 object as a parameter.
* @method Rectangle.containsPoint
* @param {Rectangle} a - The Rectangle object.
* @param {Vec2} point - The point object being checked. Can be Vec2 or any object with .x and .y values.
* @return {boolean} A value of true if the Rectangle object contains the specified point; otherwise false.
*/
...
* @return {Rectangle} A Rectangle object that equals the area of intersection. If the Rectangles do not intersect, this method returns an empty Rectangle object; that is, a Rectangle with its x, y, width, and height properties set to 0.
*/
Rectangle.intersection = function (a, b, out) {
...
* @return {Rectangle} A Rectangle object that is the union of the two Rectangles.
*/
Rectangle.union = function (a, b, out) {

    if (typeof out === "undefined") { out = new Rectangle(); }
